...
class BlueDoor(x: Int, y: Int, map:Map, game: MainGame): Tile(x,y,map,game){

    override var tileID = 16
    override var name = "BlueDoor"
    override var texture = game.getTileTexture("blueDoorTile")
